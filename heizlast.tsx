...
const SETS = [
  ...
  },
  {
    ...
    heat_min_kw: 1.5, heat_nom_kw: 8.6, heat_max_kw: 10.0, heat_m10_kw: 6.4, scop: 4.60, target: 0,
    seer: 8.00, cool_nom_kw: 7.5, cool_min_kw: 1.5, cool_max_kw: 9.0,
    energy_class_heat: "A++", energy_class_cool: "A++",
    op_heat_min: -25, op_heat_max: 24, op_cool_min: -10, op_cool_max: 46, refrigerant: "R32",
    pdesignh: 6.4, pdesignc: 7.5,
    dimensions: "875 x 795 x 320 mm", weight: "62 kg",
    noise_cool: 49, noise_heat: 53,
    pipe_length_max: "75 m gesamt, max. 25 m je IG",
    ...
    indoorUnits: [
      { name: "CS-Z20ZKEW Etherea (Bad)", kw: 2.0 },
      { name: "CS-Z25ZKEW Etherea (Schlafzimmer)", kw: 2.5 },
      { name: "CS-Z50ZKEW Etherea (Wohnzimmer)", kw: 5.0 },
    ],
  },
  {
    name: "Panasonic CU-2Z50ABEC + CS-HZ25ZKE + CS-HZ35ZKE Power Heat (Einzelzimmer)",
    heat_min_kw: 1.0, heat_nom_kw: 6.4, heat_max_kw: 8.0, heat_m10_kw: 5.1, scop: 4.60, target: 1,
    seer: 8.50, cool_nom_kw: 5.3, cool_min_kw: 1.0, cool_max_kw: 6.5,
    energy_class_heat: "A++", energy_class_cool: "A+++",
    op_heat_min: -25, op_heat_max: 24, op_cool_min: -10, op_cool_max: 46, refrigerant: "R32",
    pdesignh: 3.6, pdesignc: 5.3,
    dimensions: "875 x 795 x 320 mm", weight: "58 kg",
    noise_cool: 50, noise_heat: 52,
    ...
    indoorUnits: [
      { name: "CS-HZ25ZKE Nordic (Bad)", kw: 2.5 },
      { name: "CS-HZ35ZKE Nordic (Wohnzimmer)", kw: 3.5 },
    ],
  },
  {
