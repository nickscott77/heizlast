...
const SETS = [
  ...
  {
    name: "Daikin 2MXM40A2V1B9 + Perfera (Einzelzimmer)",
    heat_min_kw: 1.3, heat_nom_kw: 4.2, heat_max_kw: 5.7, heat_m10_kw: 3.0, scop: 4.64, target: 1,
    seer: 8.53, cool_nom_kw: 4.0, cool_min_kw: 1.3, cool_max_kw: 4.6,
    energy_class_heat: "A++", energy_class_cool: "A+++",
    op_heat_min: -15, op_heat_max: 18, op_cool_min: -10, op_cool_max: 46, refrigerant: "R32",
    energy_annual_heat: 966, energy_annual_cool: 122, pdesignh: 3.2, pdesignc: 4.0,
    dimensions: "552 x 852 x 350 mm", weight: "36 kg",
    noise_cool: 46, noise_heat: 47, sound_power_cool: 60, sound_power_heat: 60,
    pipe_length_max: "30 m gesamt, max. 20 m je IG",
    refrigerant_amount: "1,15 kg (R32), vorgefuellt fuer 20 m",
    power_input_heat: "0,90 (0,21-1,75) kW", power_input_cool: "0,87 (0,20-1,75) kW",
    bafa: "Ja (Daikin EKRHH Home Hub Adapter erforderlich)",
    ...
    indoorUnits: [
      { name: "CTXM15A Perfera (Bad)", kw: 1.5 },
      { name: "FTXM25A Perfera (Wohnzimmer)", kw: 2.5 },
    ],
  },
];
