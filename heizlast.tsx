...
const SETS = [
  ...
  },
  {
    ...
    pdesignh: 5.7, pdesignc: 6.8,
    dimensions: "958 x 734 x 340 mm", weight: "62 kg",
    noise_cool: 48, noise_heat: 48, sound_power_cool: 62, sound_power_heat: 62,
    pipe_length_max: "50 m gesamt, max. 25 m je IG",
    refrigerant_amount: "2,40 kg (R32)",
    bafa: "Ja",
    shopUrl: "https://www.daikin.de",
    indoorUnits: [
      { name: "FTXM20A Perfera (Schlafzimmer)", kw: 2.0, heat_kw: 2.5 },
      { name: "FVXM25B Perfera Truhengeraet (Bad)", kw: 2.5, heat_kw: 3.4 },
      { name: "FTXM35A Perfera (Wohnzimmer)", kw: 3.5, heat_kw: 4.0 },
    ],
  },
  {
    name: "Mitsubishi Heavy SCM45ZS-W + SRK20ZSX/SRF25ZS-W (Einzelzimmer)",
    ...
    pipe_length_max: "25 m je IG",
    refrigerant_amount: "1,40 kg (R32, vorgefuellt)",
    bafa: "Ja",
    shopUrl: "https://mhiae.com/units/scm45zs-w/",
    indoorUnits: [
      { name: "SRK20ZSX (Wohnzimmer)", kw: 2.0, heat_kw: 2.7 },
      { name: "SRF25ZS-W Truhengeraet (Bad)", kw: 2.5, heat_kw: 2.9 },
    ],
  },
  {
    ...
    dimensions: "550 x 765 x 285 mm", weight: "36 kg",
    noise_cool: 46, noise_heat: 48, sound_power_cool: 60, sound_power_heat: 60,
    pipe_length_max: "20 m gesamt, max. 15 m Hoehendiff.",
    refrigerant_amount: "vorgefuellt; +0,02 kg/m ab 20 m (R32)",
    bafa: "Ja",
    shopUrl: "https://www.daikin.de",
    indoorUnits: [
  ...
  {
    name: "Bosch CL7000M 79/3 E + CL7000iU W 35/25/CL5000iM CN 26 E (Ferienwohnung)",
    heat_min_kw: 1.47, heat_nom_kw: 8.2, heat_max_kw: 8.5, heat_m10_kw: 6.0, scop: 4.60, target: 0,
    seer: 8.50, cool_nom_kw: 7.9, cool_min_kw: 1.3, cool_max_kw: 9.0,
    energy_class_heat: "A++", energy_class_cool: "A+++",
    op_heat_min: -15, op_heat_max: 24, op_cool_min: -15, op_cool_max: 50, refrigerant: "R32",
    pdesignh: 6.0, pdesignc: 7.9,
    dimensions: "673 x 890 x 342 mm", weight: "61 kg",
    noise_cool: 62, noise_heat: 62, sound_power_cool: 66, sound_power_heat: 57,
    pipe_length_max: "30 m je IG",
    refrigerant_amount: "2,10 kg (R32)",
    bafa: "Ja",
    shopUrl: "https://www.bosch-homecomfort.com/de/de/ocs/wohngebaeude/climate-7000-m-ausseneinheit-21302739-p/",
    indoorUnits: [
      { name: "CL7000iU W 35 E (Wohnzimmer)", kw: 3.4, heat_kw: 4.1 },
      { name: "CL7000iU W 25 E (Schlafzimmer)", kw: 2.5, heat_kw: 4.1 },
      { name: "CL5000iM CN 26 E Truhengeraet (Bad)", kw: 2.6, heat_kw: 2.9 },
    ],
  },
  {
    name: "Bosch CL7000M 53/2 E + CL7000iU W 35/CL5000iM CN 26 E (Einzelzimmer)",
    heat_min_kw: 1.47, heat_nom_kw: 5.3, heat_max_kw: 6.74, heat_m10_kw: 4.3, scop: 4.60, target: 1,
    seer: 8.50, cool_nom_kw: 5.3, cool_min_kw: 1.0, cool_max_kw: 6.5,
    energy_class_heat: "A++", energy_class_cool: "A+++",
    op_heat_min: -15, op_heat_max: 24, op_cool_min: -15, op_cool_max: 50, refrigerant: "R32",
    pdesignh: 4.3, pdesignc: 5.3,
    dimensions: "810 x 946 x 410 mm", weight: "43.3 kg",
    noise_cool: 53, noise_heat: 53, sound_power_cool: 65, sound_power_heat: 66,
    pipe_length_max: "25 m je IG",
    refrigerant_amount: "1,50 kg (R32)",
    bafa: "Ja",
    shopUrl: "https://www.bosch-homecomfort.com/de/de/ocs/wohngebaeude/climate-7000-m-ausseneinheit-21302739-p/",
    indoorUnits: [
      { name: "CL7000iU W 35 E (Wohnzimmer)", kw: 3.4, heat_kw: 4.1 },
