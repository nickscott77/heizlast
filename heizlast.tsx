...
const SETS = [
  {
    ...
    indoorUnits: [
      ...
      { name: "FTXM35A Perfera (Schlafzimmer)", kw: 3.5 },
      { name: "FTXM50A Perfera (Wohnzimmer)", kw: 5.0 },
    ],
  },
  {
    name: "Daikin 3MXM52A + CTXM15A/2×FTXM35A Perfera (Ferienwohnung)",
    heat_min_kw: 1.3, heat_nom_kw: 6.8, heat_max_kw: 8.2, heat_m10_kw: 4.8, scop: 4.65, target: 0,
    seer: 8.50, cool_nom_kw: 5.2, cool_min_kw: 1.3, cool_max_kw: 6.5,
    energy_class_heat: "A++", energy_class_cool: "A+++",
    op_heat_min: -15, op_heat_max: 24, op_cool_min: -10, op_cool_max: 46, refrigerant: "R32",
    pdesignh: 4.8, pdesignc: 5.2,
    dimensions: "734 x 974 x 408 mm", weight: "55 kg",
    noise_cool: 46, noise_heat: 47, sound_power_cool: 59, sound_power_heat: 60,
    pipe_length_max: "60 m gesamt, max. 25 m je IG",
    refrigerant_amount: "1,6 kg (R32), vorgefuellt fuer 30 m",
    bafa: "Nein",
    shopUrl: "https://www.breeze24.com/klimaanlagen/klimaanlage-sets/monosplit-und-multisplit-set/multisplit/wandgeraete/3-wandgeraete/daikin-set-3-wandgeraete-perfera-wifi-1-5/3-5-kw-ctxm15a-2-x-ftxm35a-3mxm52a2v1b-9/8",
    indoorUnits: [
      { name: "CTXM15A Perfera (Bad)", kw: 1.5 },
      { name: "FTXM35A Perfera (Schlafzimmer)", kw: 3.5 },
  ...
  {
    name: "Mitsubishi Heavy SCM41ZS-W + SRK15/20/35ZS-WF (Ferienwohnung)",
    heat_min_kw: 1.0, heat_nom_kw: 4.5, heat_max_kw: 6.9, heat_m10_kw: 3.4, scop: 4.60, target: 0,
    seer: 9.20, cool_nom_kw: 4.0, cool_min_kw: 0.9, cool_max_kw: 5.0,
    energy_class_heat: "A++", energy_class_cool: "A+++",
    op_heat_min: -15, op_heat_max: 24, op_cool_min: -15, op_cool_max: 46, refrigerant: "R32",
    pdesignh: 3.4, pdesignc: 4.0,
    dimensions: "595 x 968 x 340 mm", weight: "42,5 kg",
    noise_cool: 47, noise_heat: 49, sound_power_cool: 62, sound_power_heat: 64,
    pipe_length_max: "40 m gesamt, max. 15 m je IG",
    refrigerant_amount: "1,60 kg (R32), vorgefuellt fuer 40 m",
    bafa: "Ja (SC-BIKN2-E Adapterplatine + RC-EX3A Kabelsteuerung erforderlich)",
    shopUrl: "https://www.breeze24.com/klimaanlagen/klimaanlage-sets/monosplit-und-multisplit-set/multisplit/wandgeraete/3-wandgeraete/mitsubishi-heavy-set-srk15zs-wf-srk20zs-wf-srk35zs-wf-scm41zs-w-wandgeraet-1-5/2-0/3-5-kw",
    indoorUnits: [
      { name: "SRK15ZS-WF (Bad)", kw: 1.5 },
      { name: "SRK20ZS-WF (Schlafzimmer)", kw: 2.0 },
  ...
  },
  {
    ...
    indoorUnits: [
      { name: "CTXA15CW Stylish (Bad)", kw: 1.5 },
      { name: "FTXA20CW Stylish (Wohnzimmer)", kw: 2.0 },
    ],
  },
  {
    name: "Daikin 2MXM50A + FTXA20CW + FTXA25CW Stylish (Einzelzimmer)",
    heat_min_kw: 1.3, heat_nom_kw: 5.6, heat_max_kw: 7.0, heat_m10_kw: 4.0, scop: 4.61, target: 1,
    seer: 8.53, cool_nom_kw: 5.0, cool_min_kw: 1.8, cool_max_kw: 5.3,
    energy_class_heat: "A++", energy_class_cool: "A+++",
    op_heat_min: -15, op_heat_max: 24, op_cool_min: -10, op_cool_max: 46, refrigerant: "R32",
    ...
    refrigerant_amount: "1,7 kg (R32), vorgefuellt fuer 20 m",
    bafa: "Ja (Daikin EKRHH Home Hub Adapter erforderlich)",
    shopUrl: "https://www.breeze24.com/klimaanlagen/klimaanlage-sets/monosplit-und-multisplit-set/multisplit/wandgeraete/2-wandgeraete/daikin-set-ftxa20cw-ftxa25cw-2mxm50a2v1b-9/8-wandgeraete-stylish-wifi-2-0/2-5-kw-r32-klimaanlag",
    indoorUnits: [
